...
function library:Window(Info)
    ...
    closeButton.MouseEnter:Connect(function()
        TweenService:Create(closeButton, TweenInfo.new(0.125, EaseStyle, EaseDir), {ImageColor3 = Color3.fromRGB(255, 66, 66)}):Play()
    end)

    closeButton.MouseLeave:Connect(function()
        TweenService:Create(closeButton, TweenInfo.new(0.125, EaseStyle, EaseDir), {ImageColor3 = Color3.fromRGB(255, 255, 255)}):Play()
    end)
    ...
    minimizeButton.MouseEnter:Connect(function()
        TweenService:Create(minimizeButton, TweenInfo.new(0.125, EaseStyle, EaseDir), {ImageColor3 = Theme.Highlight}):Play()
    end)

    minimizeButton.MouseLeave:Connect(function()
        TweenService:Create(minimizeButton, TweenInfo.new(0.125, EaseStyle, EaseDir), {ImageColor3 = Color3.fromRGB(255, 255, 255)}):Play()
    end)
    ...
    minimizeButton.MouseButton1Click:Connect(function()
        ...
        TweenService:Create(main, TweenInfo.new(0.125, EaseStyle, EaseDir), {Size = Minimized and UDim2.new(0, 500,0, 34) or UDim2.new(0, 500,0, 350)}):Play()
    ...
    function window:Tab(Info)
        ...
        tabFrame.AnchorPoint = Vector2.new(0.5, .5)
        tabFrame.Position = UDim2.new(0.5, 0, .5, 0)
        ...
        function tabtable:Section(Info)
            ...
            function sectiontable:Slider(Info)
                ...
                dragButton.MouseButton1Down:Connect(function()
                    TweenService:Create(sliderUIStroke, TweenInfo.new(0.1, EaseStyle, EaseDir), {Color = Theme.ItemUIStrokeSelected}):Play()
                end)
                ...
                dragButton.MouseButton1Down:Connect(function() -- Skidded from material ui hehe, sorry
                    ...
                    MouseMove = Mouse.Move:Connect(function()
                        ...
                        SizeFromScale = SizeFromScale - (SizeFromScale % 2)
                        TweenService:Create(sliderInner, TweenInfo.new(0.09, EaseStyle, Enum.EasingDirection.Out), {Size = UDim2.new(Px,0,0,5)}):Play()
                        local iconpos = math.clamp(Px, 0.00981, 0.99141)
                        TweenService:Create(dragIcon, TweenInfo.new(0.09, EaseStyle, Enum.EasingDirection.Out), {Position = UDim2.new(iconpos,-5,0,-2)}):Play()
                        if Info.Flag then
                ...
                textBox.Focused:Connect(function()
                    TweenService:Create(inputUIStroke, TweenInfo.new(0.1, EaseStyle, EaseDir), {Color = Theme.ItemUIStrokeSelected}):Play()
                end)

                textBox.FocusLost:Connect(function()
                    TweenService:Create(inputUIStroke, TweenInfo.new(0.1, EaseStyle, EaseDir), {Color = Theme.ItemUIStroke}):Play()
            ...
            function sectiontable:Dropdown(Info)
                ...
                dropdownTextButton.MouseButton1Down:Connect(function()
                    TweenService:Create(dropdownUIStroke, TweenInfo.new(0.125, EaseStyle, EaseDir), {Color = Theme.ItemUIStrokeSelected}):Play()
                end)
            ...
            function sectiontable:Toggle(Info)
                ...
                toggleTextButton.MouseButton1Down:Connect(function()
                    TweenService:Create(toggleUIStroke, TweenInfo.new(0.13, EaseStyle, EaseDir), {Color = Theme.ItemUIStrokeSelected}):Play()
                end)

                toggleTextButton.MouseButton1Up:Connect(function()
                    TweenService:Create(toggleUIStroke, TweenInfo.new(0.13, EaseStyle, EaseDir), {Color = Theme.ItemUIStroke}):Play()
                end)
        ...
        function tabtable:Select()
            ...
            task.spawn(function()
                for _,v in next, tabContainerScrolling:GetChildren() do
                    if v.ClassName == "Frame" and v ~= tab then
                        ...
                        TweenService:Create(v.TabFrame, TweenInfo.new(0.2, EaseStyle, EaseDir), {Size = UDim2.new(0, 118,0, 25)}):Play()
                        v.TabFrame.UIStroke.Color = Theme.TabUIStroke
                        TweenService:Create(v.TabFrame.TabName, TweenInfo.new(0.2, EaseStyle, EaseDir), {Size = UDim2.new(0, 118,0, 25)}):Play()
                    end
                end
            end)
            Left.Visible = true
            ...
            TweenService:Create(tabFrame, TweenInfo.new(0.2, EaseStyle, EaseDir), {Size = UDim2.new(0, 122,0, 25)}):Play()
            TweenService:Create(tabName, TweenInfo.new(0.2, EaseStyle, EaseDir), {Size = UDim2.new(0, 122,0, 25)}):Play()
            TweenService:Create(tabuIStroke, TweenInfo.new(0.2, EaseStyle, EaseDir), {Color = Theme.HighlightUIStroke}):Play()
            TweenService:Create(tabName, TweenInfo.new(0.125, EaseStyle, EaseDir), {TextColor3 = Theme.Highlight}):Play()
            TweenService:Create(tabFrame, TweenInfo.new(0.125, EaseStyle, EaseDir), {BackgroundColor3 = Theme.SelectedTabFrame}):Play()
        end
